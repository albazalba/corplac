...
export default function CreateListing() {
  ...
  return (
    <main className="border rounded-2xl p-6 max-w-5xl mx-auto mt-5 sm:mt-20">
      <h1 className="text-3xl font-semibold text-center my-7 text-slate-700 mt-0">
        Create a Listing
      </h1>
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4 text-[14px]">
        <div className="flex flex-col gap-4 flex-1">
          <input
            type="text"
            placeholder="Name"
            className="border p-2 rounded-lg text-[14px]"
            id="name"
            maxLength="62"
            minLength="10"
            required
          ...
          <div className="flex gap-6 flex-wrap">
            ...
            <div className="flex gap-2">
              ...
              />
              <span className="text-[14px]">Parking spot</span>
            </div>
            <div className="flex gap-2">
              <input
                type="checkbox"
              ...
              />
              <span className="text-[14px]">Furnished</span>
            </div>
            <div className="flex gap-2">
              <input
                type="checkbox"
